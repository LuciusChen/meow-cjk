...
- [[https://github.com/LuciusChen/emt][EMT]] 2.0.0+ (fork with pre-built binaries for all platforms)
...
#+begin_src elisp
;; packages.el
(package! emt :recipe (:host github :repo "LuciusChen/emt"))
...
For CJK-aware ~kill-word~ / ~backward-kill-word~, use [[https://github.com/LuciusChen/emt][EMT]]'s built-in remap:
~emt-mode~ automatically remaps ~kill-word~ → ~emt-kill-word~ and ~backward-kill-word~ → ~emt-backward-kill-word~.
...
- [[https://github.com/LuciusChen/emt][EMT]] - Cross-platform tokenizer via ewt-rs (fork with pre-built binaries)
